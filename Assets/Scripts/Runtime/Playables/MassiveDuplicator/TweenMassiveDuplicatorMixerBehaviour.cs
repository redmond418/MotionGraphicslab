...
{
    public class TweenMassiveDuplicatorMixerBehaviour : TweenAnimationMixerBehaviour<MassiveDuplicator, TweenMassiveDuplicatorBehaviour>
    {
        ...
        public override void Blend(MassiveDuplicator binding, TweenMassiveDuplicatorBehaviour behaviour, float weight, float progress)
        {
        ...
        public override void Apply(MassiveDuplicator binding)
        {
