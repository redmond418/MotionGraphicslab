...
{
    public class TweenTextMeshProMixerBehaviour : TweenAnimationMixerBehaviour<TextMeshPro, TweenTextMeshProBehaviour>
    {
        ...
        public override void Blend(TextMeshPro binding, TweenTextMeshProBehaviour behaviour, float weight, float progress)
        {
        ...
        public override void Apply(TextMeshPro binding)
        {
